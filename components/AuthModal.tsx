      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-8 pt-8 pb-6 text-center">
          ...
          <p className="text-slate-500 mt-1">
            {mode === 'signin' 
              ? 'Sign in to save your transformations' 
              : 'Join to save and share your looks'}
          </p>
        </div>
        ...
        <div className="px-8 pb-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-slate-200 rounded-xl font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-black text-white rounded-xl font-medium hover:bg-slate-800 transition-colors"
            >

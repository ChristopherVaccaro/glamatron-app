...
const GalleryModal: React.FC<GalleryModalProps> = ({ isOpen, onClose, userId }) => {
  ...
  // Keyboard navigation for detail view and modal-level escape - must be before early return
  useEffect(() => {
    if (!isOpen) return;
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      // Modal-level escape (close modal if no detail view)
      if (e.key === 'Escape') {
        e.preventDefault();
        onClose();
      }
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
          <div className="flex items-center gap-3">
            <div>
              <h2 id="gallery-modal-title" className="text-xl font-bold text-slate-900">
